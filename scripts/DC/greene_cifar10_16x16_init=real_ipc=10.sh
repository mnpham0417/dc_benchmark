...
singularity exec --nv \
	...
	/bin/bash -c "source /ext3/env.sh; python3 /home/mp5847/src/dc_benchmark/methods/dc/main.py --dataset CIFAR10 --model ConvNet --ipc 10 --Iteration 20000 --init real --data_path /home/mp5847/src/dc_benchmark/methods/dc/data --name greene_cifar10_16x16_init=real_ipc=10 --log_path ./output_DC"