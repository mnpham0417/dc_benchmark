...
singularity exec --nv \
	...
	/bin/bash -c "source /ext3/env.sh; python3 /home/mp5847/src/dc_benchmark/methods/dc/main.py --method DSA --dataset CIFAR10 --model ConvNet --ipc 10 --Iteration 1000 --data_path /home/mp5847/src/dc_benchmark/methods/dc/data --name greene_cifar10_32x32_init=noise_ipc=10 --log_path ./output_DSA"