...
singularity exec --nv \
	...
	/bin/bash -c "source /ext3/env.sh; python3 /home/mp5847/src/dc_benchmark/methods/dc/main.py --method DSA --dataset CIFAR10 --model ConvNet --ipc 50 --Iteration 1000 --data_path /home/mp5847/src/dc_benchmark/methods/dc/data --name greene_cifar10_32x32_init=real_ipc=50 --init real --log_path ./output_DSA"